...
/// let r = t.square();
/// ```
pub fn square<'a, S: Shape, E: Dtype, D: UnaryKernel<SquareKernelOp, E> + 'a, T: Tape<'a, E, D>>(
    t: Tensor<S, E, D, T>,
) -> Tensor<S, E, D, T> {
    t.square()
}

impl<'a, S: Shape, E: Dtype, D: UnaryKernel<SquareKernelOp, E> + 'a, T: Tape<'a, E, D>> Tensor<S, E, D, T> {
    /// See [square]
