...
/// let r = t.sqrt();
/// ```
pub fn sqrt<'a, S: Shape, E: Dtype, D: UnaryKernel<SqrtKernelOp, E> + 'a, T: Tape<'a, E, D>>(
    t: Tensor<S, E, D, T>,
) -> Tensor<S, E, D, T> {
    t.sqrt()
}

impl<'a, S: Shape, E: Dtype, D: UnaryKernel<SqrtKernelOp, E> + 'a, T: Tape<'a, E, D>> Tensor<S, E, D, T> {
    /// See [sqrt]
